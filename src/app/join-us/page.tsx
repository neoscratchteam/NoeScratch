    ...
    <div className="min-h-screen">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-secondary/10 border border-border/40 hover:border-primary/20 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {positions.map((position, index) => (
              <div
                key={position.title}
                className="bg-background p-6 rounded-2xl shadow-lg hover:border-primary/20 border border-border/40 transition-all duration-300"
              >
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-background rounded-2xl shadow-xl p-8 border border-border/40">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <Button type="submit" size="lg" className="w-full sm:w-auto font-bold h-12 px-8">
